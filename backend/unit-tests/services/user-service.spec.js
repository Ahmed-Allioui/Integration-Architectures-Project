...
const Role = require("../../src/security/role");
...
const demouser = new User('testuser', 'John', 'Doe', 'jd@test.com', 'secret', Role.SALESMAN.name);
const demouser2 = new User('testuser2', 'Jane', 'Doe', 'jad@test.com', 'xyz', Role.SALESMAN.name);
